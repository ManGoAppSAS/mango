...
<header class="rdm-toolbar--contenedor">
    <div class="rdm-toolbar--fila">
        <div class="rdm-toolbar--izquierda">
            <a href="compras_ver.php"><div class="rdm-toolbar--icono"><i class="zmdi zmdi-arrow-left zmdi-hc-2x"></i></div></a>
            <h2 class="rdm-toolbar--titulo">Destino</h2>
        </div>
    </div>
</header>
...
<main class="rdm--contenedor-toolbar">
    ...
    else
    {
        ...
        <h2 class="rdm-lista--titulo-largo">Elige el destino</h2>
        ...
        while ($fila = $consulta->fetch_assoc()) 
        {
            ...
            <a href="compras_ingredientes.php?local_id=<?php echo "$local_id"; ?>&crear_compra=si">
