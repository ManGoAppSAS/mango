...
<header class="rdm-toolbar--contenedor">
    <div class="rdm-toolbar--fila">
        <div class="rdm-toolbar--izquierda">
            <a href="plantillas_factura_detalle.php?plantilla_factura_id=<?php echo "$plantilla_factura_id"; ?>#ticket"><div class="rdm-toolbar--icono"><i class="zmdi zmdi-arrow-left zmdi-hc-2x"></i></div></a>
    ...
    <h2 class="rdm-lista--titulo-largo">Ticket</h2>

    <section class="rdm-factura-ticket">

        <article class="rdm-factura--ticket-contenedor">
        ...
        <div class="rdm-tarjeta--acciones-izquierda">                
            <a href="plantillas_factura_detalle_ticket_imprimir.php?plantilla_factura_id=<?php echo "$plantilla_factura_id"; ?>" target="_blank"><button class="rdm-boton--resaltado">Imprimir</button></a>
        </div>
